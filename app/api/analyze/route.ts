...
- Rappelle que le montant réel varie selon les dettes et les paiements mensuels, et qu'on appellera la personne pour confirmer (ou la référer à un courtier hypothécaire).
  ...
  try {
    ...
    const userMessage = {
      ...
      requiredSchema: {
        ...
        stats: [
          { label: "Ce que votre situation pourrait supporter", value: "entre X $ et Y $", detail: "..." },
